...
orbs:
  synthetics-ci: datadog/synthetics-ci-orb@3.15.0
...
| `polling_timeout`         | number       | _30 minutes_                              | **DEPRECATED** in favour of batch_timeout. The duration (in milliseconds) after which the action stops polling for test results. At the CI level, test results completed after this duration are considered failed.     |
