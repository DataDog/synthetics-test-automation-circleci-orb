...
orbs:
  synthetics-ci: datadog/synthetics-ci-orb@5.0.0
...
| `locations`               | Override the list of locations to run the test from, separated by new lines or commas. The possible values are listed [in this API response][3]. <br><sub>**Default:** none</sub>                                                                                                                                  |
