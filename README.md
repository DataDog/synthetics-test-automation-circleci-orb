...
| `datadog_site`            | Your Datadog site. The possible values are listed [in this table][10]. <!-- partial <br>Set it to {{< region-param key="dd_site" code="true" >}} (ensure the correct SITE is selected on the right). partial --> <br><sub>**Default:** `datadoghq.com`</sub> |
