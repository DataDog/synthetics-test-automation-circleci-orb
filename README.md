...
| `site`                    | string       | `datadoghq.com`                           | The [Datadog site][14] to send data to. Your Datadog site is {{< region-param key="dd_site" code="true" >}}. If the `DD_SITE` environment variable is set, it takes preference. |
