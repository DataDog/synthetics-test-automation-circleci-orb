...
orbs:
  synthetics-ci: datadog/synthetics-ci-orb@2.8.0
...
| `files`                   | string       | `{,!(node_modules)/**/}*.synthetics.json` | A list of glob patterns to detect Synthetic tests config files, separated by new lines or commas.                                                                                                                       |
...
| `public_ids`              | string       | _values in [test files][18]_              | A list of tests IDs for Synthetic tests you want to trigger, separated by new lines or commas.                                                                                                                          |
