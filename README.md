...
| `background`              | Whether or not this step should run in the background. <br><sub>[See official CircleCI documentation][13] for the default value.</sub>                                                                                                                                                                                  |
...
| `no_output_timeout`       | Elapsed time the command can run without output. The string is a decimal with unit suffix, such as “20m”, “1.25h”, “5s”. <br><sub>[See official CircleCI documentation][13] for the default value.</sub>                                                                                                                |
